...
function getManifest() {
    return JSON.stringify({
        ...
        "iconUrl": "https://st.truyenqqno.com/template/frontend/images/favicon.ico",
        "isEnabled": true,
        "type": "MANGA"
    });
}
...
function getUrlList(slug, filtersJson) {
    try {
        ...
        return "https://truyenqqno.com/truyen-moi-cap-nhat";
    }
}
...
function getUrlSearch(keyword, filtersJson) {
    var filters = JSON.parse(filtersJson || "{}");
    var page = filters.page || 1;
    return "https://truyenqqno.com/tim-kiem?q=" + encodeURIComponent(keyword) + "&page=" + page;
}
...
function getUrlCategories() {
    return "https://truyenqqno.com/the-loai/";
}
